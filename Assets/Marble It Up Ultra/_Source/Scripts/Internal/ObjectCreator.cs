...
public class ObjectCreator : EditorWindow
{
    ...
    void HazardsUI()
    {
        ...
        if (IconButton(content_basher_big)) CreatePrefab(BASHER_BIG, "Dynamic");
        if (IconButton(content_basher_flat)) CreatePrefab(BASHER_FLAT, "Dynamic");
        if (IconButton(content_basher_ring)) CreatePrefab(BASHER_RING, "Dynamic");
        if (IconButton(content_bumper)) CreatePrefab(BUMPER, "Gameplay");
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        if (IconButton(content_wacker_high_long)) CreatePrefab(WACKER_HIGH_LONG, "Dynamic");
        if (IconButton(content_wacker_high_short)) CreatePrefab(WACKER_HIGH_SHORT, "Dynamic");
        if (IconButton(content_wacker_low_long)) CreatePrefab(WACKER_LOW_LONG, "Dynamic");
        if (IconButton(content_wacker_low_short)) CreatePrefab(WACKER_LOW_SHORT, "Dynamic");
        if (IconButton(content_spinning_death)) CreatePrefab(SPINNING_DEATH, "Dynamic");
        GUILayout.EndHorizontal();
    }
    ...
    void SetupStyle()
    {
        ...
        this.icon_basher_big =               (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_basher_big.png", typeof(Texture));
        this.icon_basher_flat =              (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_basher_flat.png", typeof(Texture));
        this.icon_basher_ring =              (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_basher_ring.png", typeof(Texture));
        this.icon_bumper =                   (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_bumper.png", typeof(Texture));
        this.icon_wacker_high_long =         (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_wacker_high_long.png", typeof(Texture));
        this.icon_wacker_high_short =        (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_wacker_high_short.png", typeof(Texture));
        this.icon_wacker_low_long =          (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_wacker_low_long.png", typeof(Texture));
        this.icon_wacker_low_short =         (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_wacker_low_short.png", typeof(Texture));
        this.icon_spinning_death =           (Texture)AssetDatabase.LoadAssetAtPath(path + "icon_spinning_death.png", typeof(Texture));
        ...
        this.content_basher_big =            new GUIContent(icon_basher_big, "Big Basher");
        this.content_basher_flat =           new GUIContent(icon_basher_flat, "Flat Basher");
        this.content_basher_ring =           new GUIContent(icon_basher_ring, "Ring Basher");
        this.content_bumper =                new GUIContent(icon_bumper, "Bumper");
        this.content_wacker_high_long =      new GUIContent(icon_wacker_high_long, "Wacker (High, Long)");
        this.content_wacker_high_short =     new GUIContent(icon_wacker_high_short, "Wacker (High, Short)");
        this.content_wacker_low_long =       new GUIContent(icon_wacker_low_long, "Wacker (Low, Long)");
        this.content_wacker_low_short =      new GUIContent(icon_wacker_low_short, "Wacker (Low, Short)");
        this.content_spinning_death =        new GUIContent(icon_spinning_death, "Spinning Death");
    ...
    static void SetupLighting()
    {
        ...
        RenderSettings.customReflection = (Cubemap)AssetDatabase.LoadAssetAtPath(AssetDatabase.GUIDToAssetPath("5afa629037af33f41878fb7679b57a8a"), typeof(Cubemap)); // sky001_cubemap.png

        if (RenderSettings.skybox == null || RenderSettings.skybox.name == "Default-Skybox")
            RenderSettings.skybox = (Material)AssetDatabase.LoadAssetAtPath(AssetDatabase.GUIDToAssetPath("e08e55ad9ff38bb45a0eb9c6d101cf5a"), typeof(Material)); // 11.mat
    ...
    private const string BASHER_BIG = "b1c8acd3d224b1a439b94194b4ceb73d";
    private const string BASHER_FLAT = "e9afb33f4db9dc8488e4280d4d2776dd";
    private const string BASHER_RING = "c4a874b0953f97c44922ad3ef1dacced";
    private const string BUMPER = "6bf8a6447fd165a4abcf55f29bcd8061";
    private const string WACKER_HIGH_LONG = "749979cddff37fb4ea79861138f6ac28";
    private const string WACKER_HIGH_SHORT = "7b1018d749867f54a8f532c79f2887f5";
    private const string WACKER_LOW_LONG = "bb5d975ed97f92240ae857fbc9c0be7c";
    private const string WACKER_LOW_SHORT = "0c7665c199e805e4fbbbff2aafdc67a8";
    private const string SPINNING_DEATH = "34344919f645e5141b5c241415535765";
    ...
    private Texture icon_basher_big;
    private Texture icon_basher_flat;
    private Texture icon_basher_ring;
    private Texture icon_bumper;
    private Texture icon_wacker_high_long;
    private Texture icon_wacker_high_short;
    private Texture icon_wacker_low_long;
    private Texture icon_wacker_low_short;
    private Texture icon_spinning_death;
    ...
    private GUIContent content_basher_big;
    private GUIContent content_basher_flat;
    private GUIContent content_basher_ring;
    private GUIContent content_bumper;
    private GUIContent content_wacker_high_long;
    private GUIContent content_wacker_high_short;
    private GUIContent content_wacker_low_long;
    private GUIContent content_wacker_low_short;
    private GUIContent content_spinning_death;
