...
namespace MIU
{
    ...
    public class LevelObject
    {
        ...
        public const string PARTICLE_SYSTEM_PROXY = "ParticleSystemProxy";
        public const string PARTICLE_SYSTEM_PROXY_ID = "ParticleSystemProxyId";
        ...
        public const string CHECKPOINT_ORDER = CHECKPOINT + "_Order";
